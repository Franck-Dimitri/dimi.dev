...
export default function Header() {
  ...
  return (
    <header className="fixed top-4 max-w-7xl mx-auto inset-x-4 z-50 bg-white/5  backdrop-blur-lg rounded-3xl border border-fuchsia-200 dark:border-gray-900 shadow-xl transition-colors duration-300">
      ...
      {/* Menu mobile */}
      {isMenuOpen && (
        <div id="mobile-menu" className="lg:hidden space-y-2 p-2 absolute top-full left-0 right-0 mt-2 mx-4 border border-fuchsia-200 dark:border-gray-700 bg-white/10 backdrop-blur-lg  rounded-2xl shadow-xl animate-fadeInDown">
