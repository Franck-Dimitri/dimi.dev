...
export default function Header() {
  ...
  return (
    <header className="fixed top-4 inset-x-4 z-50 bg-white/80 dark:bg-gray-900 backdrop-blur-lg rounded-3xl border border-fuchsia-200 shadow-xl transition-colors duration-300">
